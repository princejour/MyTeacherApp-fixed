...
# We want to replace the body of if (uri != null) inside csvLauncher

start_pattern = r'val csvLauncher = rememberLauncherForActivityResult\(ActivityResultContracts\.GetContent\(\)\) \{ uri: Uri\? ->\s*if \(uri != null\) \{'
